package com.ratseno.book.springboot.config.auth.dto;
...
public class OAuthAttributes {
    ...
    /*
    *  of()
    * OAuth2User에서 반환하는 사용자 정보는 Map이기 떄문에 값 하나하나를 변환해야만 합니다.
    * */
    ...
    * 가입할 떄의 기본 권한을 GUEST로 주기 위해서 role 빌더값에는 Role.GUEST를 사용합니다.
