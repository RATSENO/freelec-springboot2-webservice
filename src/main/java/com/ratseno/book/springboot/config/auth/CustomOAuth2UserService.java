...
import com.ratseno.book.springboot.config.auth.dto.OAuthAttributes;
import com.ratseno.book.springboot.config.auth.dto.SessionUser;
import com.ratseno.book.springboot.domain.user.User;
import com.ratseno.book.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        * 지금은 구글만 사용하는 불필요한 값이지만, 이후
        * 네이버 로그인 연동 시에 네이버 로그인인지, 구글 로그인인지 구분하기 위해 사용합니다.
        * */
        ...
        /*
        * OAuth2 로그인 진행 시 키가되는 필드값을 이야기합니다.
        ...
        * */
        ...
        /*
        * OAuth2UserService를 통해 OAuth2User의 attribute를 담은 클래스입니다.
